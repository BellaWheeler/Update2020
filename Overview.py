...
st.markdown('The text and charts within each page will automatically update depending on the options chosen in the selection boxes. The data refer to 2020.')
